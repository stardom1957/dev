/* *******************************
cal.h version 1.0 by D. Martel
December 15, 2001
Header file for cal.c
*  *******************************
*/
...
const char *shortDayNamesF[7] = { "Di", "Lu", "Ma", "Me", "Je", "Ve", "Sa" };
const char *longDayNames[7] = { "Sunday", "Monday", "Tuesday", "Wednesday", "Thurday", "Friday", "Saturday" };
const char *longDayNamesF[7] = { "Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi" };
...
const char *shortMonthNamesF[12] = {  "Jan",
                          "Fév",
                          "Mar",
                          "Avr",
                          "Mai",
...
const char *longMonthsNamesF[12] = {  "Janvier",
                          "Février",
                          "Mars",
                          "Avril",
                          "Mai",
